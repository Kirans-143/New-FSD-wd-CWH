Inline Element = do not start on a new line and only take up as much as necessary

Block Element = these starts on a new line and take up the entire width of their container by default. They essentially claim all the horizontal spaces for themselves, pushing any content that comes after them to a new line
